...
main (int argc, char *argv[])
{
  ...
  int n_sta = 2; // Number of Stations (STAs
    ...
    float RxNoiseFigure = 10;
    float CcaEdThreshold = -75.0;
    float RxNoiseFigure = 10.0;
    float RxSensitivity = 10.0;
  ...
  int simTime = 1; // Simulation time in seconds
  ...
  wifiPhy.SetPreambleDetectionModel ("ns3::ThresholdPreambleDetectionModel", 
                                    "Threshold", DoubleValue (PreambleDetectionThresholdSnr),
                                    "MinimumRssi", DoubleValue (PreambleDetectionThresholdMinimumRssi)
                                    );
