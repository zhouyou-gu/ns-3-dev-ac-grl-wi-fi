...
NS_LOG_COMPONENT_DEFINE ("rate-config-test");
void PopulateARPcache();

int main (int argc, char *argv[])
{
  LogComponentEnable ("rate-config-test", LOG_LEVEL_INFO);
  LogComponentEnable ("OfdmPhy", ns3::LOG_LEVEL_ALL);
  LogComponentEnable ("OfdmPpdu", ns3::LOG_LEVEL_ALL);
